		...
		Withdraw.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(Sbutton.getSelection()==true) {
							...
							try {
								if(a.checkBalance(Username,"Savings")==accountS.getBalance()) {
								...
								SbalanceField.setText(SavingsBalance);
									...
									box.open();
									String SavingsBalance = String.valueOf(a.checkBalance(Username,"Savings"));
									SbalanceField.setText(SavingsBalance);
				...
				if(Cbutton.getSelection()==true) {
							...
							if(Cbutton.getSelection()==true) {
								...
								try {
									if(a.checkBalance(Username,"Checking")==accountC.getBalance()) {
									...
									CbalanceField.setText(CheckingBalance);
										...
										box.setMessage("Memory mismatch.");
										box.open();
										String CheckingBalance = String.valueOf(a.checkBalance(Username,"Checking"));
										CbalanceField.setText(CheckingBalance);
