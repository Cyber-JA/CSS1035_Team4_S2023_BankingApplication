...
/**
 * Class used to implement the savings account functionalities. This extends the
 * Account superclass.
 */
public class Savings_S2023_SJUBank extends Account_S2023_SJUBank {
	 ...
	 * 
	 * @return InterestRate Returns the set interest rate applied from the bank.
	 */
	 ...
	 * 
	 * @param interestRate Value used to set interest rate from the bank.
	 */
	 ...
	 * 
	 * @return WithdrawalsAvailable Returns the Withdrawals Available for this
	 *         account.
	 */
	 ...
	 * 
	 * @param withdrawalsAvailable Value used to set withdrawals available for this
	 *                             account.
	 */
	 ...
	 * 
	 * @param amount is the parameter received by the method to perform the
	 *               withdraw. This will be subtracted from the balance.
	 */
	@Override
	public void withdraw(double amount)
			throws InvalidAmountException, WithdrawalsAvailableException, ArithmeticException {
		if (amount <= 0) {
	...
	/**
	 * Accrued interest method Method displaying the forecast accrued interest.
	 */
