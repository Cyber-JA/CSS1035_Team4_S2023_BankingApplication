...
/**
 * Class implementing the functionalities of the checking account. Extends the
 * Account superclass.
 */
public class Checking_S2023_SJUBank extends Account_S2023_SJUBank {
	 ...
	 * Constructor
	 * 
	 * @param balance This is the initial amount set at the creation of the checking
	 *                account.
	 */
	 ...
	 * overdraftFee Getter
	 * 
	 * @return overdraftFee Returns the set fee amount when the account overdrafts.
	 */
	 ...
	 * overdraftFee Setter
	 * 
	 * @param overdraftFee Value used to set the amount of fee applied into
	 ...
	 * 
	 * @return overdraftcounter Returns the overdraft actual counter.
	 */
	 ...
	 * 
	 * @param overdraftcounter Value used to set the overdraftcounter when
	 *                         overdrafting the account.
	 */
	 ...
	 * 
	 * @return WithdrawalsFee Returns the fee applied whtn withdrawing.
	 */
	 ...
	 * 
	 * @param withdrawalsFee Value used to set the fee applied when withdrawing.
	 */
	 ...
	 *
	 * @throws ArithmeticException Exception thrown when the value overflows.
	 */
	 ...
	 * Withdraw method.
	 * 
	 * @param amount This is the amount that the user wants to withdraw from the
	 *               checking account. It is possible to perform as many withdrawals
	 *               as wanted, until the amount and/or the overdraft constraints
	 *               allow it.
	 * 
	 ...
	 * 
	 * @throws OverdraftAccountException Exception thrown when the account is
	 *                                   overdrafted and a withdrawal is requested.
	 * 
	 * @throws ArithmeticException       Exception thrown when the value overflows.
	 */
	@Override
	 ...
	 * Deposit method.
	 * 
	 * @param amount This is the amount that the owner wants to deposit into the
	 *               checking account.
	 *
	 * @throws InvalidAmountException Exception thrown when the amount is not
	 *                                correct in the context.
	 ...
	 * 
	 * @param amount This is the amount that the payment requires.
	 * 
	 * @see InvalidAmountException
	 * 
	 * @see OverdraftAccountException
